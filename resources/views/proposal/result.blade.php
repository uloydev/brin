    ...
    <section class="flex-1 py-8 px-2 md:px-8 flex flex-col items-center">
        ...
        <div
            ...
            <div class="w-full">
                ...
                @if (!$proposal->score)
                    <p class="text-2xl text-yellow-500 font-bold text-center my-12">PENGAJUAN ANDA BELUM DINILAI</p>
                @elseif ($proposal->score > 70)
                ...
                @endif
                <p>tahap selanjutnya untuk mengklaim pendanaan riset, anda diharapkan untuk memenuhi persyaratan dibawah ini
                    :</p>
                <br>
