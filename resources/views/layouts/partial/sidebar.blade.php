<aside
    ...
    <div class="relative p-6 ">
        <img class="w-40 mb-3 " src="./img/brin-logo.png" alt="BRIN LOGO">
        <span class="absolute text-slate-500 font-bold bottom-05">Dashboard BRIN</span>
    </div>
    <nav>
        @auth
            <a href="index.html" class="py-4 px-6 hover:bg-slate-500 flex items-center space-x-3 font-normal">
        ...
        @else
            <a href="{{ route('login') }}" class="py-4 px-6 hover:bg-slate-500 flex items-center space-x-3 font-normal">
                <i class="fas fa-sign-in-alt"></i>
                <span>Login</span>
            </a>
            <a href="{{ route('register') }}" class="py-4 px-6 hover:bg-slate-500 flex items-center space-x-3 font-normal">
