...
<section class="flex-1 py-8 px-2 md:px-8 flex flex-col items-center">
    ...
    <div
        ...
        <form class="w-full space-y-8" action="{{ route('login') }}" method="POST">
            @csrf
            <div class="w-full px-1 sm:px-2 max-w-md space-y-5">
                ...
                <div class="px-2 tracking-tighter space-y-2">
                    <label class="text-sm font-medium leading-none" for="password">Masukkan Password</label>
            ...
            <div class="w-full px-3">
                <button
                    class="w-full rounded-xl bg-indigo-500 hover:bg-indigo-600 shadow-indigo-700  shadow-md text-white md:py-3 font-bold" type="submit">Masuk
                </button>
            </div>
